...
class _ReasonTypeState extends State<ReasonType> {
  final List<String> listReasons=['Business Meeting','Sales','Meeting','Discussion','Service Support'];
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Reason',style: TextStyle(color: Colors.white),),
