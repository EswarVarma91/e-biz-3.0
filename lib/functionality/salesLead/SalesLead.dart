...
class StateSalesLead extends State<SalesLead>{
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
          appBar: AppBar(title: Text("Sales Lead",style: TextStyle(color: Colors.white),),
        ...
        SpeedDial(
          ...
          children: [
            SpeedDialChild(
              ...
              onTap: (){
               Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context) => NewSalesLead()),);
              }
            ),
            SpeedDialChild(
              ...
              labelStyle: TextStyle(color: Colors.white),
              onTap: (){
                Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context) => SearchDownTeam()),);
              }
            ),
          ],
        ),
                ...
                child: Container(
                   /* decoration: BoxDecoration(border: Border.all(color: lwtColor,width: 1),
                    ...
                    child: Padding(
                      ...
                      child: ListTile(
                        title: Text(listpending[index]?.srNo ?? 'NA',
                          style: TextStyle(
                              color: Colors.black,
                              fontSize: 10,
              ...
              child: InkWell(
                child: Container(
                    ...
                    child: Padding(
                      ...
                      child: ListTile(
                        title: Text(listcompleted[index]?.srNo ?? 'NA',
                              style: TextStyle(
                                  color: Colors.black,
                                  fontSize: 10,
                                  fontWeight: FontWeight.bold),
                        ...
                        subtitle: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: <Widget>[
                            Text(listcompleted[index]?.srCustomerName ?? 'NA',
                              style: TextStyle(
                                color: Colors.black54,
                                fontSize: 9,
                              ),
