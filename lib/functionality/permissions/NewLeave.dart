  ...
  getName() async{
    ...
    branchId = preferences.getString("branchid");
     ...
     //                            minTime: DateTime(2019, 3, 5),
                                 ...
                                 maxTime: DateTime(y, m,d+int.parse(leaveCount)),
                                 theme: DatePickerTheme(
                                     backgroundColor: Colors.white,
                                     itemStyle: TextStyle(
                                       color: Colors.blue,
       ...
       void callServiceInsert() async {
              ...
              //      var responseJson = json.decode(response.data);
               ...
               checkleaveStatus(String fromDate, String toDate, String uuidd) async {
                 ...
                 if (response.statusCode == 200 || response.statusCode == 201) {
                   lcm = (json.decode(response.data) as List).map((data) => new LeavesCheckingModel.fromJson(data)).toList();
                   ...
                   showDialog(
                     ...
                     builder: (BuildContext context){
                         return CupertinoAlertDialog(
                           title: Text("Leave Alert",style: TextStyle(color: lwtColor),),
                           content: Container(
                             ...
                             child: Container(
                               ...
                               child: Column(crossAxisAlignment:CrossAxisAlignment.start,children: <Widget>[
                                 ...
                                 SizedBox(height: 5,), 
                                 Row(children: <Widget>[
                                   Expanded(child: Text(list.toString(),style: TextStyle(color: Colors.red,fontWeight: FontWeight.bold),)),
                                 ],) ,     
                               ],),
                             ),
                           ),
           ...
           getUserLeaves(String fromDate, String toDate,String uuid) async {
             ...
             if(response.statusCode==200 || response.statusCode==201){
                lcdm= (json.decode(response.data) as List).map((data) => new LeavesCheckingDatesModel.fromJson(data)).toList();
